...
export default function SourcesPage() {
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro eyebrow="Grow A Colony · Verifiability" title="Source status" description="Every claim on this wiki carries a source and a claim-state label (Verified or Community-reported). Nothing is invented." />
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 grid gap-3 text-sm text-white/75">
          <p><strong className="text-white">Game identity</strong> — from the official Roblox game page (place 103154273080028, "Grow A Colony"). Verified.</p>
