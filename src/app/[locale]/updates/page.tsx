...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    title: locale === "es" ? `Actualizaciones de Grow A Colony — qué cambió · ${monthLabel}` : `Grow A Colony Updates — What's Changed · ${monthLabel}`,
    description: locale === "es"
      ? "Seguimiento de actualizaciones de Grow A Colony: cómo verificar cambios reales, dónde se anuncian, y el estado confirmado."
      : "Grow A Colony update tracking: how to verify real changes, where they're announced, and the confirmed status.",
