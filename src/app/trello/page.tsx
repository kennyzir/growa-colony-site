...
const statusRows = [
  ...
  },
  {
    ...
    note: "This site is the focused Grow A Colony wiki hub (/wiki). If the developer publishes an official wiki, it becomes the source of record and wins over community content."
  }
];
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        ...
        description="Check which Grow A Colony community sources are official, which are community-run, and where to confirm codes and updates. The official Roblox page wins when sources disagree."
      />
      <AdsterraArticleTop />
      ...
      <section className="mt-10">
        <SectionHeader
          ...
          copy="No official Grow A Colony Trello or wiki is confirmed. Use the official Roblox page as the baseline, and treat Discord and community wikis as monitored signals until a creator-owned source is confirmed."
        />
      ...
      <section className="mt-10 grid gap-4 md:grid-cols-3">
        ...
        <Link href="/wiki" className="content-card">
          ...
          <h2 className="mt-3 text-xl font-bold text-white">Grow A Colony wiki hub</h2>
