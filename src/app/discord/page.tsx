...
export const metadata: Metadata = {
  title: "Grow A Colony Discord — Official Invite Status",
  description: "Grow A Colony Discord invite status. We only link the official server when we verify it from a dated official source — never a fake invite.",
